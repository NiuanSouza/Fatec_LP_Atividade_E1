...
public class MediaFatec { 
		...
		MediaFatec(double P1, double E1, double E2, double X, double SUB, double API) 
		{ 
		    this.P1 = P1;     
		    this.E1 = E1;   
		    this.E2 = E2;     
